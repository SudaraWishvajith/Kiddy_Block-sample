    ...
    return (
        <>
            ...
            <div
                ...
                ${menuOpened ? "w-80" : "w-0"}`}
            >
                <div className="flex-1 flex items-start justify-center ml-10 flex-col gap-6 p-8">
                    <MenuButton label={"About"} onClick={() => setSection(0)} />
                    <MenuButton label={"Section01"} onClick={() => setSection(1)} />
                    <MenuButton label={"Section02"} onClick={() => setSection(2)} />
                </div>
            </div>
